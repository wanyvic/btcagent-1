...
if (LIBEVENT_LINK_STATIC) 
    FIND_LIBRARY(LIBEVENT_LIB          NAMES libevent.a          PATHS ${LibEvent_LIB_PATHS})
    FIND_LIBRARY(LIBEVENT_CORE_LIB     NAMES libevent_core.a     PATHS ${LibEvent_LIB_PATHS})
    FIND_LIBRARY(LIBEVENT_PTHREADS_LIB NAMES libevent_pthreads.a PATHS ${LibEvent_LIB_PATHS})
    FIND_LIBRARY(LIBEVENT_EXTRA_LIB    NAMES libevent_extra.a    PATHS ${LibEvent_LIB_PATHS})
    FIND_LIBRARY(LIBEVENT_OPENSSL_LIB  NAMES libevent_openssl.a  PATHS ${LibEvent_LIB_PATHS})
else ()
